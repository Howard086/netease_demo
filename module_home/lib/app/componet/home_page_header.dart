    ...
    return Container(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Image.asset(
              'packages/lib_base/assets/images/search_edit_icon.png',
              width: 14,
              height: 14,
            ),
                ...
                children: [
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        'packages/lib_base/assets/images/logo_and_text.png',
                        color: logoColorCopy(shrinkOffset),
                      ),
                    ),
                  ),
              ...
              children: [
                GestureDetector(
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        'packages/lib_base/assets/images/dcp.png',
                        width: 20,
                        height: 20,
                ...
                GestureDetector(
                  child: Column(
                    ...
                    children: [
                      Image.asset(
                        'packages/lib_base/assets/images/ic_tab_cart_normal.png',
                        width: 20,
                        height: 22,
                        color: const Color(0xFF333333),
                      ),
